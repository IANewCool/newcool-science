  ...
  lessons: [
    {
      ...
      duration: 12,
      icon: '☀️',
      theory: 'El Sol es una estrella de tamaño mediano. Produce energia por fusion nuclear, convirtiendo hidrogeno en helio.',
      facts: [
        'El Sol tiene 4.6 mil millones de años',
        'Cabrian 1.3 millones de Tierras en el Sol',
        'La luz del Sol tarda 8 minutos en llegar',
        'La temperatura del nucleo es 15 millones de grados',
      ],
    },
    {
      id: 'earth-space-2',
      title: 'Los Planetas',
      description: 'Nuestros vecinos cosmicos',
      branch: 'earth-science',
      type: 'experiment',
      difficulty: 'intermediate',
      xp: 90,
      ...
      steps: [
        {
          ...
          instruction: 'Explora Mercurio, Venus, Tierra y Marte.',
          expectedResult: 'Pequeños, solidos, cerca del Sol',
        },
        {
          id: 'step-2',
          title: 'Gigantes gaseosos',
          instruction: 'Explora Jupiter y Saturno.',
          expectedResult: 'Enormes, gaseosos, con muchas lunas',
        },
        {
          id: 'step-3',
          title: 'Gigantes de hielo',
          instruction: 'Explora Urano y Neptuno.',
          expectedResult: 'Frios, azules, muy lejanos',
        },
        {
          id: 'step-4',
          title: 'Compara tamaños',
          instruction: 'Ordena los planetas por tamaño.',
          expectedResult: 'Jupiter > Saturno > Urano > Neptuno > Tierra > Venus > Marte > Mercurio',
        },
      ],
    ...
    },
    {
      id: 'earth-space-3',
      title: 'La Luna',
      description: 'Nuestro satelite natural',
      branch: 'earth-science',
      type: 'lesson',
      difficulty: 'intermediate',
      xp: 65,
      duration: 14,
      icon: '🌙',
      theory: 'La Luna orbita la Tierra cada 27 dias. Causa las mareas y no tiene atmosfera ni agua liquida.',
      facts: [
        'La Luna se aleja 3.8cm de la Tierra cada año',
        '12 personas han caminado en la Luna',
        'La Luna siempre muestra la misma cara a la Tierra',
        'Un dia lunar dura 29 dias terrestres',
      ],
    },
    {
      id: 'earth-space-4',
      ...
      questions: [
        {
          id: 'q1',
          question: 'Cual es el planeta mas grande?',
          options: ['Saturno', 'Jupiter', 'Urano', 'Neptuno'],
          correctIndex: 1,
          explanation: 'Jupiter es el planeta mas grande, 11 veces el diametro de la Tierra.',
        },
        {
          id: 'q2',
          ...
          correctIndex: 1,
          explanation: 'La luz viaja a 300,000 km/s y tarda 8 minutos en recorrer 150 millones de km.',
        },
        {
          id: 'q3',
          question: 'Que causa las mareas?',
          options: ['El viento', 'El Sol', 'La Luna', 'Los terremotos'],
          correctIndex: 2,
          explanation: 'La gravedad de la Luna atrae el agua de los oceanos, causando mareas.',
        },
      ],
    },
  ],
